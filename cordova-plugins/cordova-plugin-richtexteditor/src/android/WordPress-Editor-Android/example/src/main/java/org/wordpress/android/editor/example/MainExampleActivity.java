...
public class MainExampleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button hotShareEditor = (Button) findViewById(R.id.hotshare_editor);
        hotShareEditor.setOnClickListener(new OnClickListener() {
            @Override public void onClick(View v) {
                Intent intent = new Intent(MainExampleActivity.this, HotShareEditorActivity.class);
                Bundle bundle = new Bundle();
                bundle.putString(HotShareEditorActivity.TITLE_PARAM, getString(R.string.example_post_1_title));
                bundle.putString(HotShareEditorActivity.CONTENT_PARAM, getString(R.string.example_post_1_content));
                bundle.putBoolean(HotShareEditorActivity.DRAFT_PARAM, false);
                intent.putExtras(bundle);
